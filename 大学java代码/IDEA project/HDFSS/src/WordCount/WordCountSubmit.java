...
public class WordCountSubmit {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, IOException {
        ...
        //设置文件路径
        FileInputFormat.setInputPaths(job,new Path("C:\\Users\\CHUAN GE PALY\\Desktop\\大数据实训\\day03\\day3\\a.txt"));
        // FileInputFormat.setInputPaths(job,new Path("/a"));
        //输出路径
        FileOutputFormat.setOutputPath(job,new Path("C:\\Users\\CHUAN GE PALY\\Desktop\\word\\"));
        //执行
