    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>MovieHall/frontlist">影厅</a></li>
                <li><a href="<%=basePath %>Movie/frontlist">影片</a></li>
                <li><a href="<%=basePath %>Schedule/frontlist">档期计划</a></li>
                <li><a href="<%=basePath %>MovieOrder/frontlist">订票</a></li>
                <li><a href="<%=basePath %>Comment/frontlist">影评</a></li>
